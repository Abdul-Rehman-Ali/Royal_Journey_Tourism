...
//
//    private static PdfGenerator.XmlToPDFLifecycleObserver xmlToPDFLifecycleObserver;
//
...
////            }
//
//            xmlToPDFLifecycleObserver = new PdfGenerator.XmlToPDFLifecycleObserver((ComponentActivity) context);
//            ((ComponentActivity) context).getLifecycle().addObserver(xmlToPDFLifecycleObserver);
//
...
////
////    /**
////     * Generates a PDF for the given invoice and template.
////     *
////     * @param selectedTemplate Layout template ID.
////     * @param booking          Invoice data.
////     * @param activity         The activity context.
////     * @param callback         Callback for PDF generation success or failure.
////     */
////    public static void generateInvoicePdf(int selectedTemplate, Invoice booking, AppCompatActivity activity, PdfGenerationCallback callback) {
////        if (activity == null || activity.getLifecycle() == null) {
////            throw new IllegalArgumentException("Provided activity is null or does not have a valid lifecycle.");
...
////
////    /**
////     * Populates the invoice view with the booking data.
////     *
...
////
////    /**
////     * Cleans up the view to prevent memory leaks.
////     *
...
////
////    /**
////     * Calculates the total price for the invoice.
////     *
////     * @param booking Invoice data.
