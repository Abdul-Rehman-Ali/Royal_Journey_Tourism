...
//        Log.d("TestingPdfCreation", "In Native API")
//
//        (view.findViewById<View>(R.id.tvGuestName) as TextView).text = booking.name
//        (view.findViewById<View>(R.id.tvPickupTime) as TextView).text = booking.pickupTime
//        (view.findViewById<View>(R.id.tvBookingDate) as TextView).text = booking.pickupDate
//        (view.findViewById<View>(R.id.tvGrandTotal) as TextView).text = "AED " + calculateTotalPrice(booking)
//        (view.findViewById<View>(R.id.tvPackageName) as TextView).text = booking.packageName ?: "N/A"
//        (view.findViewById<View>(R.id.tvPickupLocation) as TextView).text = booking.pickupLocation ?: "N/A"
//        (view.findViewById<View>(R.id.tvAdultCount) as TextView).text = booking.noOfAdults?.toString() ?: "0"
//        (view.findViewById<View>(R.id.tvKidsCount) as TextView).text = booking.noOfKids?.toString() ?: "0"
//        (view.findViewById<View>(R.id.tvPricePerKid) as TextView).text = booking.pkgPricePerKid?.toString() ?: "0.00"
//        (view.findViewById<View>(R.id.tvPricePerAdult) as TextView).text = booking.pkgPricePerAdult?.toString() ?: "0.00"
//        (view.findViewById<View>(R.id.tvTotalOnAdults) as TextView).text = calculateTotalPriceForAdults(booking).toString()
//        (view.findViewById<View>(R.id.tvTotalOnKids) as TextView).text = calculateTotalPriceForKids(booking).toString()
//        (view.findViewById<View>(R.id.tvPaymentStatus) as TextView).text = if (booking.paymentStatus) "Paid" else "Payment on Arrival"
//
//
//        val pageWidth = 1000
//        val pageHeight = 1300
...
//
//        // ✅ Define the Trip360 folder in Documents and ensure it exists
//        val trip360Dir = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS), "Trip360")
//        if (!trip360Dir.exists()) {
//            trip360Dir.mkdirs()
//        }
//
